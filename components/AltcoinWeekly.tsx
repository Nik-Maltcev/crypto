        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
                <div>
                    ...
                    <p className="text-gray-400 text-sm">
                        CMC + Reddit + Twitter → Gemini → Claude Opus 4.7 • Цель: +10% за неделю
                    </p>
                </div>
            ...
            <div className="bg-gradient-to-r from-purple-900/30 to-indigo-900/30 border border-purple-500/20 rounded-xl p-4 flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-xs text-gray-400 mt-0.5">Pipeline: CMC (trending+gainers+new) + Reddit (48ч) + Twitter → Gemini Filter → Claude Opus 4.7</p>
                </div>
            </div>
